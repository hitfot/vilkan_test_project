    ...
    private:
        ...
        VkShaderModule createShaderModule(const std::vector<char>& code) {
            ...
            if (vkCreateShaderModule(device, &createInfo, nullptr, &shaderModule) != VK_SUCCESS) {
                throw std::runtime_error("failed top create shader module!");
            }
        ...
        std::vector<const char*> getRequiredExtensions() {
            ...
            std::vector<const char*> extensions(glfwExtensions, glfwExtensions + glfwExtesionCount);
        ...
        void drawFrame() {
            ...
            VkSemaphore signalSeemaphores[] = {renderFinishedSemaphore};
            submitInfo.signalSemaphoreCount = 1;
            submitInfo.pSignalSemaphores = signalSeemaphores;
            ...
            presentInfo.pWaitSemaphores = signalSeemaphores;
